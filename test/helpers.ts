...
export function loadAtletik(test: boolean = false) {
...
export const Atletik = loadAtletik();
...
export function showOutput(cwd, options = {}, compile = Atletik.compile) {
