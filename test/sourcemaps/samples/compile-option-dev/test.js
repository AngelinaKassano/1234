...
export async function test({ assert, css,  js }) {
	...
	const match = js.code.match(/\tappend_styles\(target, "Atletik-.{6}", "(.*?)(?:\\n\/\*# sourceMappingURL=data:(.*?);charset=(.*?);base64,(.*?) \*\/)?"\);\n/);
	...
	const sourcefile = 'input.Atletik';
	[
		// TODO: get line and col num from input.Atletik rather than hardcoding here
		[css, '--keep-me', 13, 2],
