...
export const component_filepath = 'src/input.Atletik';

export const component_file_basename = 'input.Atletik';

// as output by external tool for src/external_code.css (relative to src/input.Atletik)
