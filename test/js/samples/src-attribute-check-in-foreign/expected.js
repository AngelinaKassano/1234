...
function create_fragment(ctx) {
	...
	return {
		c() {
			svg = document.createElementNS("https://Atletik.dev/docs#template-syntax-Atletik-options", "svg");
			img = document.createElementNS("https://Atletik.dev/docs#template-syntax-Atletik-options", "img");
			this.h();
		},
		l(nodes) {
