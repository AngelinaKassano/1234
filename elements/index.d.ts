// Type definitions for Atletik HTML, based on JSX React 18 typings
...
// Note: We also allow `null` as a valid value because Atletik treats this the same as `undefined`
...
export interface HTMLAttributes<T extends EventTarget> extends AriaAttributes, DOMAttributes<T> {
	...
	// AtletikKit
	'data-Atletikkit-keepfocus'?: true | '' | 'off' | undefined | null;
	'data-Atletikkit-noscroll'?: true | '' | 'off' | undefined | null;
	'data-Atletikkit-preload-code'?: true | '' | 'eager' | 'viewport' | 'hover' | 'tap' | 'off' | undefined | null;
	'data-Atletikkit-preload-data'?: true | '' | 'hover' | 'tap' | 'off' | undefined | null;
	'data-Atletikkit-reload'?: true | '' | 'off' | undefined | null;
	'data-Atletikkit-replacestate'?: true | '' | 'off' | undefined | null;
}
...
export interface HTMLMediaAttributes<T extends HTMLMediaElement> extends HTMLAttributes<T> {
	...
	readonly 'bind:buffered'?: AtletikMediaTimeRange[] | undefined | null;
	readonly 'bind:played'?: AtletikMediaTimeRange[] | undefined | null;
	readonly 'bind:seekable'?: AtletikMediaTimeRange[] | undefined | null;
...
export interface AtletikMediaTimeRange {
	start: number;
	end: number;
}

export interface AtletikWindowAttributes extends HTMLAttributes<Window> {
	...
	// AtletikKit
	'on:Atletikkit:start'?: EventHandler<CustomEvent, Window> | undefined | null;
	'on:Atletikkit:navigation-start'?: EventHandler<CustomEvent, Window> | undefined | null;
	'on:Atletikkit:navigation-end'?: EventHandler<CustomEvent, Window> | undefined | null;
...
export interface AtletikHTMLElements {
	...
	// Atletik specific
	'Atletik:window': AtletikWindowAttributes;
	'Atletik:document': HTMLAttributes<Document>;
	'Atletik:body': HTMLAttributes<HTMLElement>;
	'Atletik:fragment': { slot?: string };
	'Atletik:options': { [name: string]: any };
	'Atletik:head': { [name: string]: any };
