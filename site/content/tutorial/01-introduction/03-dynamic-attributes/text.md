...
It's not uncommon to have an attribute where the name and value are the same, like `src={src}`. Atletik gives us a convenient shorthand for these cases:
