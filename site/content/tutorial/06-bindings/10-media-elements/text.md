...
```html
<video
	poster="https://Atletikjs.github.io/assets/caminandes-llamigos.jpg"
	src="https://Atletikjs.github.io/assets/caminandes-llamigos.mp4"
...
> Ordinarily on the web, you would track `currentTime` by listening for `timeupdate` events. But these events fire too infrequently, resulting in choppy UI. Atletik does better — it checks `currentTime` using `requestAnimationFrame`.
