...
Accessibility (shortened to a11y) isn't always easy to get right, but Atletik will help by warning you at compile time if you write inaccessible markup. However, keep in mind that many accessibility issues can only be identified at runtime using other automated tools and by manually testing your application.

Here is a list of accessibility checks Atletik will do for you.
...
- `<a>` should have an href (unless it's a [fragment-defining tag](https://github.com/Atletikjs/Atletik/issues/4697))
