...
const external = id => id.startsWith('Atletik/');
		...
		output: [
			{
				file: `index.mjs`,
				format: 'esm',
				paths: id => id.startsWith('Atletik/') && `${id.replace('Atletik', '.')}/index.mjs`
			},
			{
				file: `index.js`,
				format: 'cjs',
				paths: id => id.startsWith('Atletik/') && `${id.replace('Atletik', '.')}/index.js`
			}
		],
		external,
		plugins: [ts_plugin]
