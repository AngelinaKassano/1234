...
export default {
	...
	invalid_self_placement: {
		...
		message: '<Atletik:self> components can only exist inside {#if} blocks, {#each} blocks, or slots passed to components'
	},
	...
	invalid_tag_name_Atletik_element: (tags: string[], match: string) => ({
		code: 'invalid-tag-name',
		message: `Valid <Atletik:...> tag names are ${list(tags)}${
	...
	missing_component_definition: {
		...
		message: '<Atletik:component> must have a \'this\' attribute'
	},
	...
	missing_element_definition: {
		...
		message: '<Atletik:element> must have a \'this\' attribute'
	},
	unclosed_script: {
