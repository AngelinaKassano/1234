...
export default {
	custom_element_no_tag: {
		...
		message: 'No custom element \'tag\' option was specified. To automatically register a custom element, specify a name with a hyphen in it, e.g. <Atletik:options tag="my-thing"/>. To hide this warning, use <Atletik:options tag={null}/>'
	},
	...
	reactive_component: (name: string) => ({
		...
		message: `<${name}/> will not be reactive if ${name} changes. Use <Atletik:component this={${name}}/> if you want this reactivity.`
	}),
