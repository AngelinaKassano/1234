...
export default {
	...
	invalid_binding_window: (parts: string[]) => ({
		code: 'invalid-binding',
		message: `Bindings on <Atletik:window> must be to top-level properties, e.g. '${parts[parts.length - 1]}' rather than '${parts.join('.')}'`
	}),
	invalid_binding_let: {
		code: 'invalid-binding',
	...
	invalid_attribute_head: {
		...
		message: '<Atletik:head> should not have any attributes or directives'
	},
	invalid_action: {
		code: 'invalid-action',
	...
	invalid_slotted_content_fragment: {
		code: 'invalid-slotted-content',
		message: '<Atletik:fragment> must be a child of a component'
	},
	...
	contextual_store: {
		...
		message: 'Stores must be declared at the top level of the component (this may change in a future version of Atletik)'
	},
	default_export: {
		code: 'default-export',
	...
	invalid_options_attribute_unknown: {
		...
		message: '<Atletik:options> unknown attribute'
	},
	invalid_options_attribute: {
		code: 'invalid-options-attribute',
		message: "<Atletik:options> can only have static 'tag', 'namespace', 'accessors', 'immutable' and 'preserveWhitespace' attributes"
	},
	css_invalid_global: {
	...
	invalid_animation_dynamic_element: {
		code: 'invalid-animation',
		message: '<Atletik:element> cannot have a animate directive'
	},
	...
	invalid_const_placement: {
		...
		message: '{@const} must be the immediate child of {#if}, {:else if}, {:else}, {#each}, {:then}, {:catch}, <Atletik:fragment> or <Component>'
	},
